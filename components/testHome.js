                        ...
                        <div className="flex justify-center items-center gap-x-4 w-11/12 m-auto py-2">
                            <div className="relative border rounded-md flex justify-center items-center px-4 w-2/4 dark:bg-zinc-700 dark:border-none">
                                ...
                                <div className="w-1/4 text-center flex justify-center items-center">
                                    {
                                        lengthSearch == 5 ? <span onClick={() => handleSearchCafe()} className='text-sm cursor-pointer bg-amber-600 p-1 rounded-full text-white w-full'> جست و جو کن  </span> :
                            ...
                            <div className="w-1/4 py-4 rounded-md" onClick={(e) => onClick(e)}>
                                <button className='bg-amber-600 w-full rounded-md text-white py-4 text-sm'>نصب وب اپلیکیشن</button>
                            </div>
                        </div>
                    </div>
                </div>
