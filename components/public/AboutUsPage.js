            ...
            <div className="max-w-7xl m-auto">
                ...
                <div className="my-4 p-2 bg-zinc-100 dark:bg-zinc-800">
                    <p className="leading-10 text-center">
                        پلتفرم ابری پیشرفته ما برای رشد کسب و کار شما طراحی شده است و شما را با ابزارهای مناسب برای رقابت با غول های این صنعت مجهز می کند. با در دسترس قرار دادن فناوری پیچیده، ما به طور همزمان برای شما ارزش اقتصادی، اجتماعی و زیست محیطی ایجاد می کنیم.
